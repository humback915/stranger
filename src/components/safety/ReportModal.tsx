    ...
    >
      <div className="w-full max-w-md rounded-t-2xl bg-stranger-mid p-6 pb-8">
        ...
        <div className="mb-5 flex items-center justify-between">
          <h2 className="text-lg font-bold text-stranger-light">신고하기</h2>
        ...
        {submitted ? (
          <div className="py-6 text-center">
            ...
            <p className="text-sm text-green-400">신고가 접수되었습니다</p>
            <p className="mt-1 text-xs text-gray-500">검토 후 조치하겠습니다</p>
          </div>
        ) : (
          <>
            {/* 신고 유형 선택 */}
            <div className="mb-4">
              <p className="mb-2 text-xs text-gray-400">신고 유형을 선택하세요</p>
            ...
            {/* 상세 내용 */}
            <div className="mb-5">
              <p className="mb-1.5 text-xs text-gray-400">상세 내용 (선택)</p>
              <textarea
                value={description}
